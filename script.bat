...
python imitation_learning\reward_pruning.py -t lunar_lander -f "data/tree 2022-02-14 22-22_dagger_LunarLander-v2" -o "data/lunarlander_pruned" --comp_threshold 0.98 --episodes_per_prune 100 --pruning_cycles 1 --max_pruning_iters 5 --grading_episodes 100 >> "log.txt"
ECHO -------------eof------------- >> "log.txt"
python imitation_learning\reward_pruning.py -t lunar_lander -f "data/tree 2022-02-14 21-28_dagger_LunarLander-v2" -o "data/lunarlander_pruned" --comp_threshold 0.98 --episodes_per_prune 100 --pruning_cycles 1 --max_pruning_iters 5 --grading_episodes 100 >> "log.txt"
ECHO -------------eof------------- >> "log.txt"
python imitation_learning\reward_pruning.py -t lunar_lander -f "data/tree 2022-02-14 20-15_dagger_LunarLander-v2" -o "data/lunarlander_pruned" --comp_threshold 0.98 --episodes_per_prune 100 --pruning_cycles 1 --max_pruning_iters 5 --grading_episodes 100 >> "log.txt"
ECHO -------------eof------------- >> "log.txt"
python imitation_learning\reward_pruning.py -t lunar_lander -f "data/tree 2022-02-14 18-59_dagger_LunarLander-v2" -o "data/lunarlander_pruned" --comp_threshold 0.98 --episodes_per_prune 100 --pruning_cycles 1 --max_pruning_iters 5 --grading_episodes 100 >> "log.txt"
ECHO -------------eof------------- >> "log.txt"