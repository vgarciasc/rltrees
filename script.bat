...
python imitation_learning\visualize_tree.py -t lunar_lander -f "data/tree 2022-02-15 01-01_LunarLander-v2_pruned_0" -c QTree -i 100 --task_solution_threshold 200 --grading_episodes 1000 >> "log.txt"
python imitation_learning\visualize_tree.py -t lunar_lander -f "data/tree 2022-02-15 03-15_LunarLander-v2_pruned_0" -c QTree -i 100 --task_solution_threshold 200 --grading_episodes 1000 >> "log.txt"
python imitation_learning\visualize_tree.py -t lunar_lander -f "data/tree 2022-02-15 05-50_LunarLander-v2_pruned_0" -c QTree -i 100 --task_solution_threshold 200 --grading_episodes 1000 >> "log.txt"
python imitation_learning\visualize_tree.py -t lunar_lander -f "data/tree 2022-02-15 14-58_LunarLander-v2_pruned_0" -c QTree -i 100 --task_solution_threshold 200 --grading_episodes 1000 >> "log.txt"