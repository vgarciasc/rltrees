...
axs[0, 0].scatter(range(len(qtree.left.history)), [a_left for (a_left, a_right) in qtree.left.history], s=2, color="green")
axs[0, 0].set_title("$Q(s_{PA \leq 0}; LEFT)$")
axs[1, 0].scatter(range(len(qtree.left.history)), [a_right for (a_left, a_right) in qtree.left.history], s=2, color="green")
axs[1, 0].set_title("$Q(s_{PA \leq 0}; RIGHT)$")
axs[0, 1].scatter(range(len(qtree.right.history)), [a_left for (a_left, a_right) in qtree.right.history], s=2, color="red")
axs[0, 1].set_title("$Q(s_{PA > 0}; LEFT)$")
axs[1, 1].scatter(range(len(qtree.right.history)), [a_right for (a_left, a_right) in qtree.right.history], s=2, color="red")
